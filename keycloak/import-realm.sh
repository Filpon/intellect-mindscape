...
echo "Keycloak is ready to receive connections!"

# Log in to Keycloak
/opt/keycloak/bin/kcadm.sh config credentials --server $KEYCLOAK_URL_PORT --realm $KC_REALM_NAME --user $KEYCLOAK_ADMIN --password $KEYCLOAK_ADMIN_PASSWORD
