...
# Define JSON files and output file
...
echo "Envs are substituted. Results are saved in $OUTPUT_FILE_CLIENT and $OUTPUT_FILE_USER."
...
# Variables
# REALM_JSON_FILE="/tmp/import/realm-config.json"  # Adjust the path as necessary /tmp/import/realm-mod.json
